...
@extend_schema_view(list=extend_schema(summary="Получить список заказов", ),
                    update=extend_schema(summary="Изменение существующего заказа", ),
                    create=extend_schema(summary="Создание нового заказа", ),
